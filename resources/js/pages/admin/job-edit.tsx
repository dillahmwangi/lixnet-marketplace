...
export default function JobEdit() {
    ...
    const [job, setJob] = useState<Job>(pageProps.job || {});
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await axios.put(`/api/admin/jobs/${job.id}`, formData);
        ...
        <AppLayout>
            <div className="max-w-4xl mx-auto px-4 py-8">
                ...
                <div className="mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-dark-blue">Edit Job</h1>
